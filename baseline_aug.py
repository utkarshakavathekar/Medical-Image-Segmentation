...
if __name__ == '__main__':
    ...
    #train_data = list(zip(sorted(glob('D:/KLE-PHD/Student-Projects/1/medical_image_segmentation-master/input/DRIVE/training/images/*.tif')),
     #                     sorted(glob('D:/KLE-PHD/Student-Projects/1/medical_image_segmentation-master/input/DRIVE/training/1st_manual/*.gif'))))
