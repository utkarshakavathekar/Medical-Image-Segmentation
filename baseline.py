...
if __name__ == '__main__':
    ...
    #validation_data = list(zip(sorted(glob('../input/DRIVE/CHASE_Segmentation/1/test/images/*.tif')),sorted(glob('../imput/DRIVE/CHASE_Segmentation/1/test/2nd_manual/*.gif'))))

    validation_data = list(zip(sorted(glob('C:/Users/admin/Desktop/medical1/input/DRIVE/CHASE_Segmentation/1/test/images/*.tif')),sorted(glob('C:/Users/admin/Desktop/medical1/input/DRIVE/CHASE_Segmentation/1/test/2nd_manual/*.gif'))))
    ...
    history = model.fit_generator(gen(train_data, au=False),steps_per_epoch= 100*len(train_data)//batch_size, epochs=2, verbose=2,use_multiprocessing=False, workers=1,validation_data=gen(validation_data, au=False),validation_steps=100*len(validation_data)//batch_size)
